...
use Longxiaoyang\NacosClient\Proxy\Ast;
use Longxiaoyang\NacosClient\Proxy\CodeLoader;
...
class ProxyFactory
{
    ...
    /**
     * @var \Hyperf\NacosClient\Proxy\CodeLoader
     */
    ...
    public function createProxy($serviceClass): string
    {
        ...
        $dir = BASE_PATH . '/runtime/container/proxy/nacos/';
        if (! file_exists($dir)) {
            mkdir($dir, 0755, true);
        }
        ...
        $path = $dir . $proxyFileName . '.nacos-client.proxy.php';
